...
#matchScore
optimization_domain_vertices = [[1.93693693694, 0.369369369369, 0.693693693694], [0.0, 0.0, 0.0], [5.0, 5.0, 5.0], [1.0, 1.0, 1.0]]
...
tuner = SimpleTuner(optimization_domain_vertices, matchScore, exploration_preference=exploration)
...
#x0 = np.array([1.93693693694, 0.369369369369, 0.693693693694])
x0 = np.array([0.3515625, 0.0703125, 0.1171875])
scipy.optimize.basinhopping(matchScore, x0, niter=100, T=1.0, stepsize=0.3)

with open('results_basinhopping.json', 'w') as fp:
