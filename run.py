...
def main(inputfile,
         ...
         weight_rp_steps0.10002239003499142,
         max_rp_steps=15,
         topX=10,
         thermo_ceil=8901.2,
         thermo_floor=-7570.2,
    ...
    image_str = 'brsynth/rpglobalscore-standalone:v1'
    try:
...
if __name__ == "__main__":
    ...
    parser.add_argument('-weight_rp_steps', type=float, default=.10002239003499142)
